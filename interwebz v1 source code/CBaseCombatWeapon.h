...
namespace ValveSDK
{
	...
	public:
		...
		float GetSpread()
		{
			...
			return getvfunc<GetSpread_t>( this, 451)( this );
		}

		float GetCone()
		{
			typedef float(__thiscall *GetCone_t)(PVOID);
			return getvfunc<GetCone_t>( this, 481 )( this );
		}

		void UpdateAccuracyPenalty()
		{
			typedef void(__thiscall *UpdateAccuracyPenalty_t)(PVOID);
			getvfunc<UpdateAccuracyPenalty_t>( this, 482)( this );
		}
		...
		void* GetWeaponData( )
		{
			return getvfunc<void*( __thiscall* )( void* )>( this, 459)( this );
		}
	};
}