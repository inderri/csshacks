...
public:
	...
	{
		static auto offset = g_NetworkedVariableManager.GetOffset(/*DT_BaseEntity*/XorStr<0x7D, 14, 0xB7E0165A>( "\x39\x2A\x20\xC2\xE0\xF1\xE6\xC1\xEB\xF2\xEE\xFC\xF0" + 0xB7E0165A ).s, /*m_clrRender*/XorStr<0x0A, 12, 0x6A96886C>( "\x67\x54\x6F\x61\x7C\x5D\x75\x7F\x76\x76\x66" + 0x6A96886C ).s );
		return *(color32*)((DWORD)this + offset);
	}

	bool IsSpawnProtectedPlayer()
	{
		static auto offset = g_NetworkedVariableManager.GetOffset(/*DT_CSPlayer*/XorStr<0xAA, 12, 0x6F938DD5>( "\xEE\xFF\xF3\xEE\xFD\xFF\xDC\xD0\xCB\xD6\xC6" + 0x6F938DD5 ).s, /*m_bGunGameImmunity*/XorStr<0xDE, 19, 0xCA2CA6B5>( "\xB3\x80\x82\xA6\x97\x8D\xA3\x84\x8B\x82\xA1\x84\x87\x9E\x82\x84\x9A\x96" + 0xCA2CA6B5 ).s );
	...
	bool IsPlayer()
	{
		return getvfunc<bool( __thiscall* )( void* )>( this, ISPLAYER)( this );
	}
	...
	{
		static int iOffset = g_NetworkedVariableManager.GetOffset(/*DT_BasePlayer*/XorStr<0xC2, 14, 0xCFD8B52B>( "\x86\x97\x9B\x87\xA7\xB4\xAD\x99\xA6\xAA\xB5\xA8\xBC" + 0xCFD8B52B ).s, /*m_aimPunchAngle*/XorStr<0xEA, 16, 0x4D0C6C95>( "\x87\xB4\x8D\x84\x83\xBF\x85\x9F\x91\x9B\xB5\x9B\x91\x9B\x9D" + 0x4D0C6C95 ).s );
		return *(Vector*)((DWORD)this + iOffset);
	}
